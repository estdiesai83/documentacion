3. # sockets:  (argumentos json)
   ...
   ```json
   {"nemo" : "4", "location_id": "id_ubicacion", "floor": "id_planta", "group": "id_grupo", "room": "id_estancia", "zone": "id_zona" , "value": "valor tp"}
   valor tipo*: 0 -> posicion; 1-> dim;
   ```
   ...
   ```json
   {"nemo" : "9", "location_id": "id_ubicacion", "floor": "id_planta", "group": "id_grupo", "room": "id_estancia","zone": "id cuadro", "element": "id automatico", "value": "valor tp" , "type": "valor tipo*"}
   ...
   ```json
   {"nemo" : "14", "location_id": "id_ubicacion", "floor": "id_planta", "group": "id_grupo", "room": "id_estancia", "zone": "id_zona" , "type": "valor tipo*", "value": "valor tp"}
   ...
   ```json
   {"nemo" : "15", "location_id": "id_ubicacion", "floor": "id_planta", "group": "id_grupo", "room": "id_estancia", "zone": "id_zona" , "type": "valor tipo*", "value": "valor tp"}
   ...
   ```json
   {"nemo" : "23",  "sunrise": "hh:mm", "sunset": "HH:MM"}
   ...
   ```json
   {"nemo" : "25", "nemo_configuration" : "nemo_configuration", "location_id": "id_ubicacion",  "configuration": "id_configuration*", "action": "valor accion*", domoType*": "tipo domo", "type*": "tipo_configuration", (**) }
   $json.= '","location_id":"'. $GLOBALS['DATA']->location_id ;
                     
   
   
   valor accion*: 0-> crear, 1-> modificar, 2 -> borrar 
   valor domoType*: 0-> luces, 1-> clima, 2->iot, 3->estor,4->persianas (solo configuracion para scene)
   valor type: 0-> escena 1-> AtHome
   
   (**) si action es crear o modificar: ademas le llegará ,"lights":[{id:, nemo:, status:, brightness: , color: }],"climate":[{id:,  status: , thermostate}],"iot":[{id:, status:}],"blinds":[{id:, status:, level:}],"louvers":[{id:, status:, level:}]
   ...
   ```json
   {"nemo" : "26", "nemo_mode" : "nemo_mode", "location_id": "id_ubicacion",  "mode": "id_mode", "action*": "valor accion*",  "type": "type"}
   
   valor accion*: 0-> crear, 1-> modificar, 2 -> borrar 
   valor type: 0-> standar 1-> Other
   ...
   ```json
   {"nemo" : "27",  "location_id": "id_ubicacion",  "athome": "idathome", "status": "idstatus",  "model": "idmodel"}
