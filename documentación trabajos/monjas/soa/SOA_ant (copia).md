...
Cada vez que se hace un cambio en la tabla iot, mira si los valores que tiene la tabla luces, coincide con algun caso de la tabla operacion_iot para el codigo_iot correspondiente:
