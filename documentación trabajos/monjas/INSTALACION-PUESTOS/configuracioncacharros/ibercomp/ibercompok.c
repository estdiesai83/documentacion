...
gint valorrespaldocontador_ibercomp(GList *datalista)
{
	...
	{		
		...
		tramaida[0] = comando;				//CADA CONTADOR 4 DIRECCIONES DIFERENTES//poner a x//
		tramaida[1] = 196;
		tramaida[2] = 17;	//reg=17
		tramaida[3] = valor13_ida;
		tramaida[4] = tramaida[0] + tramaida[1] + tramaida[2] + tramaida[3];
		tramaida[5] = 0;
		//
		...
		tramaida2[4] = tramaida[0] + tramaida[1] + tramaida[2] + tramaida[3];
		tramaida2[5] = 0;
		//
		tramaida3[1] = 196;
		tramaida3[2] = 19;	//reg=19
		tramaida3[3] = valor13_ida;
		tramaida3[4] = tramaida[0] + tramaida[1] + tramaida[2] + tramaida[3];
		tramaida3[5] = 0;
		//
		tramaida4[1] = 196;
		tramaida4[2] = 20;	//reg=20
		tramaida4[3] = valor13_ida;
		tramaida4[4] = tramaida[0] + tramaida[1] + tramaida[2] + tramaida[3];
		tramaida4[5] = 0;
		//		
		g_printf("\nfuncionesespeciales----programar ibercomp----puerto---->%s---->tramaida:[%d][%d][%d][%d][%d]\n",puerto,tramaida[0],tramaida[1],tramaida[2],tramaida[3],tramaida[4]);
		...
		if( (estado!=-1) && (fdpuerto>=0) )
		{
				...
				//
				sleep(1);
				respuesta = FEF_escribirpuertoserie_funcionesespeciales_libgsksoa(fdpuerto,tramaida2,5);
				//
				sleep(1);
