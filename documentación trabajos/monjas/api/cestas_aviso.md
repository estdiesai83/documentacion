...
1. ### Aviso/escribirAvisoInmediato -> Notice/writeImmediateNotice

   ```
   data: 
   1. receptors (n receptores (token_id tabla rc)
   2. attachment_id: (codigo adjunto)
   3. type: tipo (0-> normal, 1-> urgente)
   4. transmitter (1 emisor (token_id tabla usuario))
   ```
...
12. ### Aviso/disablePostHistorical
...
13. ### Aviso/activatePostHistorical
...
14. ### Aviso/readHistoricalProcess
...
1. ##### Aviso/createImmediatePost(receptors, text, transmitter)
...
2. ##### Aviso/createConversationPost(receptors, text, transmitter, post_code)
...
4. ##### Aviso/getConversationPost(post_code, user_id)
...
8. ##### Aviso/createScheduledPost(receptors, text, transmitter,day, month, year, hour, minute)
...
11. ##### Aviso/leerUsuariosHistorico -> Aviso/readUsersHistorical(transmitter)

    Lee de la tabla "usuario" los valores de los tdatos ( id, nombre y nemo) donde los tipo sea 0 y activo sea 0

    

12. ##### Aviso/readPostFilteredHistorical(day_from, month_from, year_from, day_until, month_until, year_until, users, transmitter)
...
13. ##### Aviso/deletePostHistorical(ids)
...
15. ##### Aviso/disableHistoricalPost(whose, id)
...
16. ##### Aviso/activateHistoricalPost(whose, id)
...
17. ##### Aviso/getHistoricalProcess(id)
