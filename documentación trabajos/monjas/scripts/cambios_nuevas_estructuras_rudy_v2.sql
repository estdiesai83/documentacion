...
DROP TABLE IF EXISTS `relacionambiente`;
DROP TABLE IF EXISTS `relacionestor`;
DROP TABLE IF EXISTS `relaciongrupoluces`;
DROP TABLE IF EXISTS `relacionluces`;
...
ALTER TABLE `trb_analizador` CHANGE COLUMN `codigorb` `codigo_rb` int(11) DEFAULT NULL;
ALTER TABLE `trb_readwatt_e` CHANGE COLUMN `codigorb` `codigo_rb` int(11) DEFAULT NULL;
ALTER TABLE `trb_readwatt_s` CHANGE COLUMN `codigorb` `codigo_rb` int(11) DEFAULT NULL;
ALTER TABLE `trb_smart_x100` CHANGE COLUMN `codigorb` `codigo_rb` int(11) DEFAULT NULL;
ALTER TABLE `trb_smart_x835` CHANGE COLUMN `codigorb` `codigo_rb` int(11) DEFAULT NULL;
...
ALTER TABLE `th_analizador` CHANGE COLUMN `codigotp` `codigo_tp` int(11) DEFAULT NULL;
ALTER TABLE `th_readwatt_e` CHANGE COLUMN `codigotp` `codigo_tp` int(11) DEFAULT NULL;
ALTER TABLE `th_readwatt_s` CHANGE COLUMN `codigotp` `codigo_tp` int(11) DEFAULT NULL;
ALTER TABLE `th_smart_x100` CHANGE COLUMN `codigotp` `codigo_tp` int(11) DEFAULT NULL;
ALTER TABLE `th_smart_x835` CHANGE COLUMN `codigotp` `codigo_tp` int(11) DEFAULT NULL;
...
CREATE TABLE `estor` (
  ...
  `fecha` timestamp NOT NULL DEFAULT current_timestamp(),
  `nemo` varchar(140) DEFAULT NULL,
  `consigna` varchar(11) DEFAULT NULL,
  `codigo_estancia` int(11) NOT NULL,
